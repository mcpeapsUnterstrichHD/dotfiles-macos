...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.0.0/arm64-darwin23")
  ...
  CONFIG["TEENY"] = "0"
  CONFIG["PATCHLEVEL"] = "0"
  CONFIG["INSTALL"] = '/opt/homebrew/opt/coreutils/bin/ginstall -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/mahd/.rvm/rubies/ruby-3.0.0")
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/mahd/.rvm/rubies/ruby-3.0.0"
  ...
  CONFIG["DLDFLAGS"] = "-L/opt/homebrew/opt/libyaml/lib -L/opt/homebrew/opt/libksba/lib -L/opt/homebrew/opt/readline/lib -L/opt/homebrew/opt/zlib/lib -L/opt/homebrew/opt/openssl@1.1/lib -Wl,-undefined,dynamic_lookup"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["target"] = "arm64-apple-darwin23"
