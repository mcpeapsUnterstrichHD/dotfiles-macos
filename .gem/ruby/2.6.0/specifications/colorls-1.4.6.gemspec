...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<diffy>.freeze, ["~> 3".freeze])
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.22.0".freeze])
  s.add_development_dependency(%q<rubocop-performance>.freeze, ["~> 1.13.0".freeze])
  s.add_development_dependency(%q<rubocop-rake>.freeze, ["~> 0.5".freeze])
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 2.9.0".freeze])
